...
type FieldValidator struct {
	...
	// validate this field using the named ruleset
	Rules                *string  `protobuf:"bytes,17,opt,name=rules" json:"rules,omitempty"`
...
func (*FieldValidator) Descriptor() ([]byte, []int) {
	return fileDescriptor_validator_1977ceadbdc126cf, []int{0}
}
...
func (m *FieldValidator) GetRules() string {
...
var E_Rules = &proto.ExtensionDesc{
	...
	Tag:           "varint,65020,opt,name=rules",
	Filename:      "github.com/mwitkow/go-proto-validators/validator.proto",
}
...
func init() {
	proto.RegisterFile("github.com/mwitkow/go-proto-validators/validator.proto", fileDescriptor_validator_1977ceadbdc126cf)
}

var fileDescriptor_validator_1977ceadbdc126cf = []byte{
	// 446 bytes of a gzipped FileDescriptorProto
	,
}
